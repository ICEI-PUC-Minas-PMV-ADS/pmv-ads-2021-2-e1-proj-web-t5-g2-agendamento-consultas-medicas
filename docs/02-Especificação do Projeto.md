...
|RF-07|**Alteração de dados Médicos** - O site deve permitir que o administrador altere informações do cadastro do médico: Nome, CPF, Valor, Especialidade, Horário, Jornada, E-mail, Telefone.                                                          |Alta|
|RF-08|**Cancelamento de consulta** - O site deve permitir que o paciente/administrador cancele/reagende consultas.                                                          |Média|
|RF-09| **Consultar Histórico** - O site deve permitir a visualização ou relatório com histórico do paciente/médico/administrador.                                              |Alta |
...
|RF-12| **Confirmação de agendamento** - O site deve notificar o paciente confirmando o agendamento.                                                                         |Média| 
...
|RF-14|**Lembrete Periódico** - O site deve notificar o cliente de 6 em 6 meses informando quando foi a ultima consulta.                                                     |Baixa|
|RF-15|**Pré consulta Médico/Clínica** - O site deve notificar ao administrador quando efetuado um agendamento informando os dados do paciente, m.                        |Média|
