...
|RF-06| **Consultar Médicos** - O site deve permitir a visualização com informações como Nome do médico, Especialidade, Convênio, Cidade, Telefone e E-mail.                                                                                                                                                                   |Alta |
...
|RF-09| **Consultar Histórico** - O site deve permitir a visualização histórico de consultas por mês e situação: concluído, cancelado, agendado.                                              |Alta |
